...
export default function HeroSection() {
  return (
    <section className="pt-24 sm:pt-30 md:pt-36 pb-10 md:pb-16 page-container relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="relative overflow-hidden rounded-[2rem] border border-blue-100/80 bg-white/90 px-5 sm:px-8 md:px-12 py-8 sm:py-10 md:py-12 shadow-[0_20px_80px_-40px_rgba(37,99,235,0.5)]">
